...
class OctopusApi(ABC):
    ...
    def extract_gas_details(self):
        ...
        gas_serial_numbers = self.account_dict['properties'][0]['gas_meter_points'][0]['meters']
        gas_details['serial_number']= [e['serial_number'] for e  in gas_serial_numbers if e['serial_number'] !='']
    ...
    def generate_dataframe(self, spark):
        ...
        while self.con_url is not None:
            ...
            max_date = datetime.datetime.strptime(max_date, '%Y-%m-%dT%H:%M:%S%z')
